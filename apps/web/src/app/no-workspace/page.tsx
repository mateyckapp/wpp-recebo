  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 max-w-md w-full text-center">
        ...
        <h1 className="text-lg font-semibold text-gray-900 mb-2">Workspace nÃ£o encontrado</h1>
        <p className="text-sm text-gray-500 mb-6">
          Para aceder Ã  plataforma, usa o URL do teu workspace:
          <br />
          <span className="font-mono text-brand-600 text-xs">
            https://&lt;nome-empresa&gt;.wpprecebo.com
          </span>
        </p>
