        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6">
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <div className="flex items-start gap-2">
                <span className="text-amber-400 flex-shrink-0">→</span>
                <p><strong className="text-gray-300">Ainda com problemas?</strong> Contacta o suporte em <a href="mailto:suporte@wpprecebo.pt" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">suporte@wpprecebo.pt</a>.</p>
              </div>
            </div>
          </div>
