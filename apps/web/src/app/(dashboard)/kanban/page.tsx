    ...
    <div className="flex h-full gap-4 overflow-hidden">
      ...
      <div className={`flex-1 min-w-0 overflow-hidden transition-all duration-300 ${selectedConversationId ? 'hidden md:block' : ''}`}>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            href="/kanban/configurar"
            className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-gray-200 border border-white/10 hover:border-white/20 rounded-lg px-3 py-1.5 transition-all"
          >
