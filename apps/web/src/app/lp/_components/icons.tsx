export function MessageCircleIcon({ size = 18, color = '#000' }: { size?: number; color?: string }) {
  return (
...
export function MessageWarningIcon() {
  return (
...
export function ClockIcon({ color = '#f87171' }: { color?: string }) {
  return (
