...
function getRootLoginUrl(host: string, request: NextRequest): URL {
  ...
  // Remove subdomínio: demo.localhost → localhost | tenant.wpprecebo.com → wpprecebo.com
...
export function middleware(request: NextRequest): NextResponse {
  ...
  if (!slug) {
    const allowedWithoutTenant = ['/', '/login', '/register', '/forgot-password', '/reset-password', '/verify-email', '/no-workspace', '/lp', '/trial-expired', '/produtos', '/docs', '/terms', '/privacy', '/cookies', '/pagar', '/refund'];
